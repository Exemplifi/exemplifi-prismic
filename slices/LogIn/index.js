...
/**
 * @typedef {import("@prismicio/client").Content.LogInSlice} LogInSlice
 * @typedef {import("@prismicio/react").SliceComponentProps<LogInSlice>} LogInProps
 * @param { LogInProps }
 */
const LogIn = ({ slice }) => (
  ...
  <form action="">
    ...
    <span className = "text-sm tracking-wide text-gray-600 dark:text-gray-300">
